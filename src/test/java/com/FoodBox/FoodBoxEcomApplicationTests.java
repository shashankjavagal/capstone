...
class FoodBoxEcomApplicationTests {
	...
	void UserTest() {
		...
		user.setEmail("milana@gmail.com");
	...
	void UserProductOrderDataTest() {
		...
		od.setId(112l);		
		od.setAddress("Sampige road Malleshwara");
		od.setCity("Bengaluru");
		od.setEmail("sjh@gmail.com");
		od.setFirstName("shashank");
		od.setLastName("JH");
		od.setPhoneno("707653210");
